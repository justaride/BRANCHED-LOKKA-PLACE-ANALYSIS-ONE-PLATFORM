...
import { loadAllEiendommer } from '@/lib/loaders/roger-vodal';

export const metadata = {
  title: 'Roger Vodal Eiendommer',
  description: 'Oversikt over Roger Vodals eiendommer på Brenneriveien',
};

export default async function RogerVodalEiendommerPage() {
      ...
      <section className="border-b border-gray-200 bg-gradient-to-br from-lokka-primary to-lokka-secondary py-12 text-white">
        <Container>
          ...
          <p className="text-lg text-white/90">
            Utforsk placeanalyser og eiendomsinformasjon for Roger Vodals
            portefølje på Brenneriveien
          </p>
        </Container>
      </section>
