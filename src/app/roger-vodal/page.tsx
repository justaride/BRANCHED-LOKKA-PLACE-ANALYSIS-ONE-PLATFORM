...
export default function RogerVodalHome() {
  return (
    <>
      {/* Hero Section */}
        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <p className="mb-8 text-xl text-white/90">
              Omfattende placeanalyser og eiendomsinformasjon for Roger Vodals
              eiendommer på Grünerløkka. Utforsk demografi, markedsdata og
              utviklingstrender for tre eiendommer på Brenneriveien.
            </p>
            <div className="flex gap-4">
              <Link href="/roger-vodal/eiendommer">
                <Button
                  size="lg"
              ...
              <Link href="/roger-vodal/om-prosjektet">
                <Button
                  size="lg"
                  variant="outline"
      ...
      <section className="relative w-full overflow-hidden bg-gray-100">
        <div className="relative h-[400px] w-full md:h-[500px] lg:h-[600px]">
          <Image
            src="/images/companies/roger-vodal.jpg"
            alt="Grünerløkka område - Roger Vodal portefølje"
            fill
        ...
        <div className="rounded-xl border-2 border-blue-200 bg-blue-50 p-6 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <Link
                href="/roger-vodal/om-prosjektet#kontakt"
      ...
      <section className="bg-gradient-to-br from-indigo-600 to-purple-600 py-16">
        <Container>
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-8 text-xl text-white/90">
              Se detaljerte placeanalyser, markedsdata og nøkkelinformasjon for alle 3 eiendommer i Roger Vodal sin portefølje på Grünerløkka.
            </p>
            <Link href="/roger-vodal/eiendommer">
              <Button
                size="lg"
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600">
                ...
                for hver eiendom på Brenneriveien.
              </p>
            </CardContent>
          </Card>
