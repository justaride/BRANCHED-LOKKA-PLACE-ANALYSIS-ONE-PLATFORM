...
export const metadata = {
  title: 'Om Prosjektet - Roger Vodal',
  description: 'Informasjon om Place Analysis for Roger Vodals eiendomsportefølje',
};

export default function RogerVodalOmProsjektetPage() {
  return (
    <Container>
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-4 text-gray-600">
              Dette er en dedikert plattform for placeanalyser av Roger Vodals eiendomsportefølje.
