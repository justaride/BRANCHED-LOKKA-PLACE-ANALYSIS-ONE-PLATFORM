...
import { loadAllEiendommer } from '@/lib/loaders/brodrene-evensen';

export const metadata = {
  title: 'Brødrene Evensen Eiendommer',
  description: 'Oversikt over Brødrene Evensens eiendommer på Grünerløkka',
};

export default async function BrodreneEvensenEiendommerPage() {
      ...
      <section className="border-b border-gray-200 bg-gradient-to-br from-lokka-primary to-lokka-secondary py-12 text-white">
        <Container>
          ...
          <p className="text-lg text-white/90">
            Utforsk placeanalyser og eiendomsinformasjon for Brødrene Evensens
