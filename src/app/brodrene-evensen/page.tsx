    ...
    <>
        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <div className="flex gap-4">
              ...
              <Link href="/brodrene-evensen/om-prosjektet">
                <Button
                  size="lg"
                  variant="outline"
      ...
      <section className="relative w-full overflow-hidden bg-gray-100">
        <div className="relative h-[400px] w-full md:h-[500px] lg:h-[600px]">
          <Image
            src="/images/companies/brodrene-evensen.webp"
            alt="Grünerløkka område - Brødrene Evensen portefølje"
            fill
        ...
        <div className="rounded-xl border-2 border-blue-200 bg-blue-50 p-6 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <Link
                href="/brodrene-evensen/om-prosjektet#kontakt"
