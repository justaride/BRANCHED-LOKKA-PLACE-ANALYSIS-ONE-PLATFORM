...
export const metadata = {
  title: 'Om Prosjektet - SiO',
  description: 'Informasjon om Place Analysis for SiOs eiendomsportefølje',
};

export default function SioOmProsjektetPage() {
  return (
    <Container>
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-4 text-gray-600">
              Dette er en dedikert plattform for placeanalyser av SiO (Studentsamskipnaden i Oslo og Akershus) sin eiendomsportefølje.
            ...
            <p className="text-gray-600">
              SiOs eiendommer spiller en sentral rolle i studentlivet i Oslo-regionen. Analysene hjelper
              oss å forstå og dokumentere eiendommenes utvikling, attraktivitet og funksjon i det
              studentøkologiske landskapet.
            </p>
          </CardContent>
        </Card>
