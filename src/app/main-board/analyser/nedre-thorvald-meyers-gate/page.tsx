...
export const metadata: Metadata = {
  ...
  description: 'Komplett markedsanalyse for Nedre Thorvald Meyers Gate med demografi, besøkende, virksomheter og omsetning',
};
    ...
    <>
      ...
      <section className="relative overflow-hidden border-b border-gray-200">
        <div className="relative aspect-[16/9] w-full md:aspect-[21/9]">
          <Image
            src="/images/analyser/nedre-thorvald-meyers-gate-aerial.png"
            alt="Fugleperspektiv av Nedre Thorvald Meyers Gate"
            fill
            priority
      ...
      <Container className="py-12">
        ...
        <section className="mb-20">
          ...
          <div className="mb-8">
            <ExpandableImage
              src="/images/analyser/nedre-thorvald-meyers-gate-streetmap.png"
              alt="Detaljert lokasjonskart - Nedre Thorvald Meyers Gate"
              width={1200}
              height={800}
        ...
        <section className="mb-20">
          ...
          <div className="mb-8">
            ...
            <ExpandableImage
              src="/images/analyser/nedre-thorvald-meyers-gate-heatmap.png"
              alt="Heat map - Geografisk opprinnelse av besøkende til Nedre Thorvald Meyers Gate"
              width={1200}
              height={800}
              borderColor="blue"
              bgColor="blue-50"
        ...
        <section className="mb-20">
          ...
          <div className="mb-8">
            ...
            <ExpandableImage
              src="/images/analyser/nedre-thorvald-meyers-gate-aerial-zoom.png"
              alt="Satellittbilde - Nedre Thorvald Meyers Gate med virksomhetsmarkering"
              width={1600}
              height={1200}
              borderColor="purple"
              bgColor="purple-50"
