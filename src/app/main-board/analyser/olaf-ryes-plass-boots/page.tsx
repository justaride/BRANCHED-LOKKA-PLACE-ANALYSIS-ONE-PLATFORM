...
import aktorData from '@/data/main-board/aktorer/olaf-ryes-plass-boots.json';
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-white/80">
                <div className="flex items-center gap-2">
                  ...
                  <span>9 aktører registrert</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="mb-16">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="rounded-2xl border-2 border-natural-sage/20 bg-gradient-to-br from-natural-sage/5 to-white p-6 shadow-medium">
              ...
              <p className="mb-2 text-4xl font-bold text-lokka-primary">9,500</p>
              <p className="text-sm text-lokka-secondary">Gjennomsnitt (estimert)</p>
            </div>
            ...
            <div className="rounded-2xl border-2 border-blue-200/50 bg-gradient-to-br from-blue-50 to-white p-6 shadow-medium">
              ...
              <p className="mb-2 text-4xl font-bold text-blue-900">NOK 2.8M</p>
            ...
            <div className="rounded-2xl border-2 border-purple-200/50 bg-gradient-to-br from-purple-50 to-white p-6 shadow-medium">
              ...
              <p className="mb-2 text-2xl font-bold text-purple-900">Fitness 24 Seven</p>
              <p className="text-sm text-purple-700">40.08% markedsandel</p>
              <div className="mt-4 text-xs text-purple-600">
                <p>NOK 36M omsetning årlig</p>
              </div>
            </div>
            ...
            <div className="rounded-2xl border-2 border-amber-200/50 bg-gradient-to-br from-amber-50 to-white p-6 shadow-medium">
              ...
              <p className="mb-2 text-4xl font-bold text-amber-900">NOK 89M</p>
        ...
        <section className="mb-20">
            ...
            <ExpandableImage
              ...
              caption={
                <p className="text-sm text-lokka-secondary">
                  <strong>Lokasjonskart:</strong> Området er sentrert rundt Olaf Ryes Plass og Sofienberggata 6,
                  med Boots Apotek, Fitness 24 Seven og flere restaurant- og handelskonsepter.
                </p>
              }
            />
          </div>
          ...
          <div className="mb-8 grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-xl bg-natural-sage/10 p-6">
              ...
              <p className="mb-1 text-3xl font-bold text-lokka-primary">121</p>
              <p className="text-sm text-lokka-secondary">Registrerte ansatte</p>
            </div>
            ...
            <div className="rounded-xl bg-natural-sage/10 p-6">
              ...
              <p className="text-sm text-lokka-secondary">Registrerte virksomheter</p>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="rounded-lg bg-blue-50 p-4">
                <p className="text-sm text-blue-900">
                  <strong>Kompakt område:</strong> Med 0.005 km² er dette et svært kompakt område på Grünerløkka,
                  med høy konsentrasjon av handel, tjenester og spisesteder.
                </p>
              </div>
              <div className="rounded-lg bg-purple-50 p-4">
                <p className="text-sm text-purple-900">
                  <strong>Variert virksomhetsmiks:</strong> Området har en god balanse mellom treningssenter (Fitness 24 Seven),
                  apotek (Boots), restauranter (Illegal Burger, Roma Pizzeria, Hvice) og handel (Fretex, Tint).
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-20">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-xl bg-blue-50 p-6">
                <h4 className="mb-2 text-sm font-semibold uppercase tracking-wider text-blue-900/70">
                  Estimert daglig besøk
                </h4>
                <p className="mb-1 text-3xl font-bold text-blue-900">9,500</p>
                <p className="text-sm text-blue-700">Høy trafikkfrekvens</p>
              </div>
              ...
              <div className="rounded-xl bg-blue-50 p-6">
                ...
                <p className="mb-1 text-2xl font-bold text-blue-900">Olaf Ryes Plass</p>
                <p className="text-sm text-blue-700">Et av Grünerløkkas mest trafikkerte knutepunkter</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="mb-6 text-sm text-lokka-secondary">
              ...
              med sterk konsentrasjon fra Grünerløkka og omkringliggende bydeler.
            </p>
            ...
            <ExpandableImage
              ...
              caption={
                <p className="text-xs text-lokka-secondary">
                  Olaf Ryes Plass tiltrekker seg primært lokale besøkende fra Grünerløkka og nærområder,
                  med spredt besøk fra resten av Oslo.
                </p>
              }
            />
          </div>
          ...
          <div className="rounded-xl bg-blue-50 p-6">
            ...
            <div className="space-y-2 text-sm text-blue-800">
              <p><strong>Status:</strong> Estimerte data</p>
              <p><strong>Kilde:</strong> Telia / Plaace.ai</p>
        ...
        <section className="mb-20">
          ...
          <div className="mb-8 grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-xl bg-purple-50 p-6">
              ...
              <p className="mb-1 text-3xl font-bold text-purple-900">NOK 89M</p>
              <p className="text-sm text-purple-700">Årlig (2024)</p>
            </div>
            ...
            <div className="rounded-xl bg-purple-50 p-6">
              ...
              <p className="mb-1 text-3xl font-bold text-purple-900">121</p>
              <p className="text-sm text-purple-700">Arbeidsplasser</p>
            </div>
          </div>

          {/* Top 2 actors dominance */}
          <div className="mb-8 rounded-2xl border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-white p-6 shadow-medium md:p-8">
            <h3 className="mb-4 text-xl font-bold text-purple-900">Topp 2 Aktører - Markedsdominans</h3>
            <p className="mb-6 text-sm text-purple-700">
              Området er dominert av Fitness 24 Seven og Boots Apotek, som til sammen står for over 62% av omsetningen.
            </p>

            {/* Fitness 24 Seven */}
            <div className="mb-6 rounded-xl bg-white p-6">
              <div className="mb-4 flex items-center justify-between">
                <span className="text-lg font-bold text-purple-900">Fitness 24 Seven</span>
                <span className="text-2xl font-bold text-purple-900">40.08%</span>
              </div>
              <div className="h-6 w-full overflow-hidden rounded-full bg-gray-200">
                <div className="h-full rounded-full bg-purple-500" style={{ width: '40.08%' }}></div>
              </div>
              <div className="mt-4 grid grid-cols-3 gap-4 text-center text-sm">
                <div>
                  <p className="font-semibold text-purple-900">NOK 36M</p>
            ...
            <div className="mb-6 rounded-xl bg-white p-6">
              <div className="mb-4 flex items-center justify-between">
                <span className="text-lg font-bold text-purple-900">Boots Apotek Grünerløkka</span>
                <span className="text-2xl font-bold text-purple-900">22.15%</span>
              </div>
              <div className="h-6 w-full overflow-hidden rounded-full bg-gray-200">
                <div className="h-full rounded-full bg-blue-500" style={{ width: '22.15%' }}></div>
              </div>
              <div className="mt-4 grid grid-cols-3 gap-4 text-center text-sm">
                <div>
                  <p className="font-semibold text-purple-900">NOK 20M</p>
                  <p className="text-gray-600">Omsetning</p>
                </div>
                <div>
                ...
                <div>
                  <p className="font-semibold text-red-700">-10%</p>
                  <p className="text-gray-600">YoY vekst</p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-lg bg-purple-100 p-4">
              <p className="text-sm text-purple-900">
                <strong>Observasjon:</strong> Treningssenteret Fitness 24 Seven dominerer med 40% markedsandel,
                mens Boots Apotek (22%) står for en betydelig del av handelen. Resterende 7 aktører utgjør
                kun 38% av omsetningen, hvor Mat og opplevelser-segmentet har høyt antall ansatte (80).
              </p>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <ExpandableImage
              ...
              caption={
                <p className="text-sm text-lokka-secondary">
                  <strong>Området:</strong> Kompakt område på Olaf Ryes Plass med høy konsentrasjon av
                  virksomheter og besøkende. Boots Apotek og Fitness 24 Seven utgjør hovedankerene.
                </p>
              }
            />
          </div>
        ...
        <section className="mb-20">
          ...
          <div className="mb-8 grid gap-6 md:grid-cols-2">
            <div className="rounded-xl bg-amber-50 p-6">
              ...
              <p className="mb-1 text-3xl font-bold text-amber-900">NOK 2.8M</p>
              <p className="text-sm text-amber-700">Estimert daglig omsetning</p>
            </div>
            ...
            <div className="rounded-xl bg-amber-50 p-6">
              ...
              <p className="mb-1 text-3xl font-bold text-amber-900">NOK 89M</p>
              <p className="text-sm text-amber-700">Total registrert omsetning (2024)</p>
            </div>
          </div>
          ...
          <div className="rounded-xl bg-amber-50 p-6">
            ...
            <div className="space-y-2 text-sm text-amber-800">
              <p><strong>Status:</strong> Estimerte data basert på virksomhetsdata</p>
              <p><strong>Kilde:</strong> Analysebutikken / BankAxept</p>
              <p><strong>Periode:</strong> 01.10.2022 – 30.09.2025</p>
              <p><strong>Observasjon:</strong> Varierende vekst - Fitness 24 Seven vokser (+12%), mens Boots Apotek synker (-10%)</p>
            </div>
          </div>
        </section>
