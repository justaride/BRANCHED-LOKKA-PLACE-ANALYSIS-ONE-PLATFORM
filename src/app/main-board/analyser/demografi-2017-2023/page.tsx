          ...
          <div className="mb-8 grid grid-cols-2 gap-4 md:gap-6 lg:grid-cols-4">
            <div className="group relative overflow-hidden rounded-xl border border-gray-200/50 bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-md md:rounded-2xl md:p-6">
              ...
              <div className="relative mt-4">
                <div className="mb-2 text-2xl font-bold text-natural-forest md:text-3xl">2017-2019</div>
                <div className="text-sm text-gray-600">Tidlig periode</div>
                <div className="mt-2 text-xs text-gray-500">Grunnlinje for sammenligning</div>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-xl border border-gray-200/50 bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-md md:rounded-2xl md:p-6">
              ...
              <div className="relative mt-4">
                <div className="mb-2 text-2xl font-bold text-natural-forest md:text-3xl">2020</div>
                <div className="text-sm text-gray-600">Pandemi-år</div>
                <div className="mt-2 text-xs text-gray-500">COVID-19 påvirkning</div>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-xl border border-gray-200/50 bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-md md:rounded-2xl md:p-6">
              ...
              <div className="relative mt-4">
                <div className="mb-2 text-2xl font-bold text-natural-forest md:text-3xl">2021-2022</div>
                <div className="text-sm text-gray-600">Normalisering</div>
                <div className="mt-2 text-xs text-gray-500">Gradvis gjenopptaking</div>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-xl border border-gray-200/50 bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-md md:rounded-2xl md:p-6">
              ...
              <div className="relative mt-4">
                <div className="mb-2 text-2xl font-bold text-natural-forest md:text-3xl">2023</div>
                <div className="text-sm text-gray-600">Seneste data</div>
                <div className="mt-2 text-xs text-gray-500">Nåværende situasjon</div>
              </div>
            </div>
          </div>
