...
export const metadata = {
  title: "Grünerløkka 2025 - Årsrapport",
  description: "Komplett stedsanalyse for Grünerløkka 2025",
};

export default async function Analyse2025Page() {
  ...
  const aktorkartImage = allKonkurranseScreenshots.find(
  ...
  const _korthandelScreenshots =
    analysis.plaaceData.screenshots?.filter(
      (s) => s.kategori === "korthandel",
    ) || [];

  const _bevegelseScreenshots =
    analysis.plaaceData.screenshots?.filter(
  ...
  const besokendeScreenshots =
    analysis.plaaceData.screenshots?.filter(
      (s) => s.kategori === "besokende",
    ) || [];

  const internasjonalScreenshots =
    analysis.plaaceData.screenshots?.filter(
      (s) => s.kategori === "internasjonal",
    ) || [];

  const utviklingScreenshots =
    analysis.plaaceData.screenshots?.filter(
    ...
    <>
          ...
          <Container>
            <div className="mb-6 md:mb-8">
              ...
              <p className="mt-2 text-sm text-gray-600 md:text-base">
                Viktigste data for Grünerløkka i 2025
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-6 lg:grid-cols-4">
              {analysis.plaaceData.nokkeldata.befolkning ? (
                <div className="group relative overflow-hidden rounded-xl border border-gray-200/50 bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-md md:rounded-2xl md:p-6 md:hover:-translate-y-1">
                  ...
                  <div className="relative">
                    ...
                    <div className="mb-1 text-2xl font-bold text-natural-forest md:text-4xl">
                      {analysis.plaaceData.nokkeldata.befolkning.toLocaleString(
                        "nb-NO",
                      )}
                    </div>
                ...
                <div className="group relative overflow-hidden rounded-xl border border-dashed border-gray-300 bg-gray-50 p-4 md:rounded-2xl md:p-6">
                  <div className="relative text-center">
                    <div className="mb-1 text-[10px] font-semibold uppercase tracking-wider text-gray-400 md:mb-2 md:text-xs">
                      Befolkning
                    </div>
                    <div className="mb-1 text-lg font-medium text-gray-400 md:text-xl">
                      Data kommer
                    </div>
                  </div>
                </div>
              ...
              {analysis.plaaceData.nokkeldata.dagligTrafikk ? (
                <div className="group relative overflow-hidden rounded-xl border border-gray-200/50 bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-md md:rounded-2xl md:p-6 md:hover:-translate-y-1">
                  ...
                  <div className="relative">
                    ...
                    <div className="mb-1 text-2xl font-bold text-natural-forest md:text-4xl">
                      {analysis.plaaceData.nokkeldata.dagligTrafikk.toLocaleString(
                        "nb-NO",
                      )}
                    </div>
                    <div className="text-xs text-gray-600 md:text-sm">
              ...
              {analysis.plaaceData.nokkeldata.besokende ? (
                <div className="group relative overflow-hidden rounded-xl border border-gray-200/50 bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-md md:rounded-2xl md:p-6 md:hover:-translate-y-1">
                  ...
                  <div className="relative">
                    ...
                    <div className="mb-1 text-2xl font-bold text-natural-forest md:text-4xl">
                      {analysis.plaaceData.nokkeldata.besokende.toLocaleString(
                        "nb-NO",
                      )}
                    </div>
                    <div className="text-xs text-gray-600 md:text-sm">
      ...
      {analysis.events && analysis.events.length > 0 && (
        <section className="border-b border-gray-200/30 bg-gradient-to-br from-purple-50/30 via-pink-50/20 to-blue-50/30 py-8 md:py-12">
          <Container>
            <div className="mb-6 md:mb-8">
              <h2 className="text-2xl font-bold text-natural-forest md:text-3xl">
                Nøkkelarrangementer 2025
              </h2>
              <p className="mt-2 text-sm text-gray-600 md:text-base">
                De største arrangementene som preget Grünerløkka i 2025
              </p>
            </div>
      ...
      {timelineEvents && timelineEvents.length > 0 && (
        <section className="border-b border-gray-200/30 bg-gradient-to-br from-green-50/20 via-emerald-50/10 to-teal-50/20 py-8 md:py-12">
          <Container>
            <div className="mb-6 md:mb-8">
              <h2 className="text-2xl font-bold text-natural-forest md:text-3xl">
                Aktivitetstidslinje 2025
              </h2>
              <p className="mt-2 text-sm text-gray-600 md:text-base">
                Koordinert visning av banktransaksjoner og{" "}
                {timelineEvents.length} arrangementer gjennom året
              </p>
            </div>
            ...
            <div className="mt-6 rounded-xl border border-green-200/50 bg-gradient-to-br from-green-50/50 to-emerald-50/50 p-4 md:rounded-2xl md:p-6">
              ...
              <div className="space-y-2 text-xs leading-relaxed text-gray-700 md:text-sm">
                <p>
                  <strong>Banktransaksjoner (daglig):</strong> Øvre graf viser
                  daglige korthandel-transaksjoner på Grünerløkka (inkludert +5
                  Urbant område).
                </p>
                <p>
                  <strong>Arrangementer (månedlig):</strong> Nedre graf viser
                ...
                >
                  ...
                  <div className="mb-3 flex flex-wrap items-center gap-2 text-xs md:text-sm">
                    ...
                    >
                      ...
                      {article.sentiment === "balansert" && "⚖️ Balansert"}
                    ...
                    <span className="text-gray-600">
                      📊 {article.antallArtikler}{" "}
                      {article.antallArtikler === 1 ? "artikkel" : "artikler"}
                    </span>
                  </div>
                  ...
                  {article.publikasjoner &&
                    article.publikasjoner.length > 0 && (
      ...
      <Container className="py-12 md:py-16 lg:py-20">
        <div className="mb-12 md:mb-20">
          ...
          <KonkurransebildeCharts basePath="/data/main-board/2025-arsrapport" />
        </div>
        ...
        <div className="mb-12 md:mb-20">
          <BevegelseCharts basePath="/data/main-board/2025-arsrapport" />
        </div>
