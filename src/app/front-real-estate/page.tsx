...
export default function MallingCoHome() {
  return (
    <>
      {/* Hero Section */}
        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <p className="mb-8 text-xl text-gray-600">
              Omfattende placeanalyser og eiendomsinformasjon for Front Real Estate sine
              eiendommer på Grünerløkka. Utforsk demografi, markedsdata og
              utviklingstrender for to eiendommer i området.
            </p>
            <div className="flex gap-4">
              <Link href="/front-real-estate/eiendommer">
                <Button
                  size="lg"
              ...
              <Link href="/front-real-estate/om-prosjektet">
                <Button
                  size="lg"
                  variant="outline"
      ...
      <section className="relative w-full overflow-hidden bg-gray-100">
        <div className="relative h-[400px] w-full md:h-[500px] lg:h-[600px]">
          <Image
            src="/images/companies/malling-co.jpg"
            alt="Grünerløkka område - Front Real Estate portefølje"
            fill
        ...
        <div className="rounded-xl border-2 border-blue-200 bg-blue-50 p-6 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <Link
                href="/front-real-estate/om-prosjektet#kontakt"
        ...
        <Container>
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-8 text-lg text-gray-600">
              Se detaljerte placeanalyser, markedsdata og nøkkelinformasjon for eiendommen i Front Real Estate sin portefølje på Grünerløkka.
            </p>
            <Link href="/front-real-estate/eiendommer">
              <Button
                size="lg"
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600">
                ...
                for hver eiendom på Grünerløkka.
              </p>
            </CardContent>
          </Card>
