...
export const metadata = {
  title: 'Om Prosjektet - Front Real Estate',
  description: 'Informasjon om Place Analysis for Front Real Estate eiendommer på Grünerløkka',
};

export default function FrontRealEstateOmProsjektetPage() {
  return (
    <Container>
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-4 text-gray-600">
              Dette er en dedikert plattform for placeanalyser av Front Real Estate eiendommer på Grünerløkka, Oslo.
            ...
            <p className="text-gray-600">
              Grünerløkka er et av Oslos mest dynamiske og attraktive områder, med rik historie og
              kontinuerlig utvikling. Analysene hjelper oss å forstå og dokumentere eiendommenes
              rolle i dette levende bydelsbildet.
            </p>
          </CardContent>
        </Card>
