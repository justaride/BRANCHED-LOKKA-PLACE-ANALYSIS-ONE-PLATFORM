...
import { loadAllEiendommer } from '@/lib/loaders/carucel';

export const metadata = {
  title: 'Carucel Eiendomsportefølje',
  description: 'Oversikt over Carucel sin eiendom på Olaf Ryes plass, Grünerløkka',
};

export default async function CarucelEiendommerPage() {
