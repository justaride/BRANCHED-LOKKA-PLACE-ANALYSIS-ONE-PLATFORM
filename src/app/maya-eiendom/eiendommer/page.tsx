...
import { loadAllEiendommer } from '@/lib/loaders/maya-eiendom';

export const metadata = {
  title: 'Maya Eiendom Portefølje',
  description: 'Oversikt over Maya Eiendoms eiendommer på Markveien',
};

export default async function MayaEiendomEiendommerPage() {
      ...
      <section className="border-b border-gray-200 bg-gray-50 py-12">
        <Container>
          ...
          <p className="text-lg text-gray-600">
            Utforsk placeanalyser og eiendomsinformasjon for Maya Eiendoms
            portefølje på Markveien
          </p>
        </Container>
      </section>
