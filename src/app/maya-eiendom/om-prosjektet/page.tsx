...
export const metadata = {
  ...
  description: 'Informasjon om Place Analysis for Maya Eiendoms eiendommer i Oslo',
};

export default function MayaEiendomOmProsjektetPage() {
  return (
    <Container>
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-4 text-gray-600">
              Dette er en dedikert plattform for placeanalyser av Maya Eiendoms eiendommer i Oslo.
