...
export default function MayaEiendomHome() {
  return (
    <>
      {/* Hero Section */}
        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <p className="mb-8 text-xl text-gray-600">
              Omfattende placeanalyser og eiendomsinformasjon for Maya Eiendoms
              eiendommer på Grünerløkka. Utforsk demografi, markedsdata og
              utviklingstrender for fire eiendommer på Markveien.
            </p>
            <div className="flex gap-4">
              <Link href="/maya-eiendom/eiendommer">
                <Button
                  size="lg"
              ...
              <Link href="/maya-eiendom/om-prosjektet">
                <Button
                  size="lg"
                  variant="outline"
      ...
      <section className="relative w-full overflow-hidden bg-gray-100">
        <div className="relative h-[400px] w-full md:h-[500px] lg:h-[600px]">
          <Image
            src="/images/companies/maya-eiendom.jpg"
            alt="Grünerløkka område - Maya Eiendom portefølje"
            fill
        ...
        <div className="rounded-xl border-2 border-blue-200 bg-blue-50 p-6 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <Link
                href="/maya-eiendom/om-prosjektet#kontakt"
