...
export const metadata = {
  title: 'Om Prosjektet - Spabo Eiendom',
  description: 'Informasjon om Place Analysis for Spabo Eiendoms eiendommer på Grünerløkka',
};

export default function SpaboOmProsjektetPage() {
  return (
    <Container>
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-4 text-gray-600">
              Dette er en dedikert plattform for placeanalyser av Spabo Eiendoms eiendommer på Grünerløkka, Oslo.
