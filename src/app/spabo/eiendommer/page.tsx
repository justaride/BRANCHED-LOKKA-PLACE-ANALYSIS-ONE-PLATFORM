...
import { loadAllEiendommer } from '@/lib/loaders/spabo';

export const metadata = {
  title: 'SPABO Eiendom Portefølje',
  description: 'Oversikt over SPABO Eiendoms eiendommer på Grünerløkka',
};

export default async function SpaboEiendommerPage() {
