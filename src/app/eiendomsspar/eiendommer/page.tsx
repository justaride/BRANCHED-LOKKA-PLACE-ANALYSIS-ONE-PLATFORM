...
import { loadAllEiendommer } from '@/lib/loaders/eiendomsspar';

export const metadata = {
  title: 'Eiendomsspar Portefølje',
  description: 'Oversikt over Eiendomsspars eiendommer på Thorvald Meyers gate',
};

export default async function EiendomssparEiendommerPage() {
      ...
      <section className="border-b border-gray-200 bg-gray-50 py-12">
        <Container>
          ...
          <p className="text-lg text-gray-600">
            Utforsk placeanalyser og eiendomsinformasjon for Eiendomsspars
            portefølje på Thorvald Meyers gate
          </p>
        </Container>
      </section>
