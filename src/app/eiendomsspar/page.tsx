...
export default function EiendomssparHome() {
  return (
    <>
      {/* Hero Section */}
        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <p className="mb-8 text-xl text-white/90">
              Omfattende placeanalyser og eiendomsinformasjon for Eiendomsspars
              portefølje på Grünerløkka. Utforsk demografi, markedsdata og
              utviklingstrender for tre eiendommer på Thorvald Meyers gate.
            </p>
            <div className="flex gap-4">
              <Link href="/eiendomsspar/eiendommer">
                <Button
                  size="lg"
              ...
              <Link href="/eiendomsspar/om-prosjektet">
                <Button
                  size="lg"
                  variant="outline"
      ...
      <section className="relative w-full overflow-hidden bg-gray-100">
        <div className="relative h-[400px] w-full md:h-[500px] lg:h-[600px]">
          <Image
            src="/images/companies/eiendomsspar.jpg"
            alt="Grünerløkka område - Eiendomsspar portefølje"
            fill
        ...
        <div className="rounded-xl border-2 border-blue-200 bg-blue-50 p-6 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <Link
                href="/eiendomsspar/om-prosjektet#kontakt"
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600">
                ...
                for hver eiendom på Thorvald Meyers gate.
              </p>
            </CardContent>
          </Card>
