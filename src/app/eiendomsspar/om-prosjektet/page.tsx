...
export const metadata = {
  title: 'Om Prosjektet - Eiendomsspar',
  description: 'Informasjon om Place Analysis for Eiendomsspars eiendomsportefølje',
};

export default function EiendomssparOmProsjektetPage() {
  return (
    <Container>
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-4 text-gray-600">
              Dette er en dedikert plattform for placeanalyser av Eiendomsspars eiendomsportefølje.
