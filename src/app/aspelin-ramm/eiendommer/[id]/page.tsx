          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:gap-12">
            ...
            <div className="flex-1">
              <FadeIn delay={100} direction="up">
                <h1 className="mb-2 text-3xl font-bold leading-tight tracking-tight text-gray-900 md:mb-4 md:text-5xl lg:text-6xl">{displayName}</h1>
                {eiendom.navn && (
                  <p className="mb-4 text-lg text-gray-500 md:mb-6 md:text-xl">{eiendom.adresse}</p>
                )}
              </FadeIn>
              {eiendom.beskrivelse && (
                ...
                <div className="md:col-span-2">
                  <div className="rounded-xl border border-gray-200/50 bg-lokka-light/30 p-4 md:rounded-2xl md:p-6">
                    ...
                    <p className="text-xs leading-relaxed text-lokka-secondary md:text-sm">
                      Eiendommen ligger på Vulkan, et av Oslos mest dynamiske områder med utmerket tilgjengelighet
