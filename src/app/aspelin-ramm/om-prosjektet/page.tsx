...
export const metadata = {
  ...
  description: 'Informasjon om Place Analysis for Aspelin Ramms eiendommer på Vulkan',
};

export default function AspelinRammOmProsjektetPage() {
  return (
    <Container>
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-4 text-gray-600">
              Dette er en dedikert plattform for placeanalyser av Aspelin Ramms eiendommer på Vulkan-området.
            ...
            <p className="text-gray-600">
              Vulkan-området representerer et unikt FutureBuilt-prosjekt med fokus på bærekraftig byutvikling,
              energieffektivitet og sosial bærekraft. Disse analysene hjelper oss å forstå og dokumentere
              områdets utvikling og attraktivitet.
            </p>
          </CardContent>
        </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <ul className="mt-4 space-y-2 text-gray-600">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1 text-lokka-primary">•</span>
                  <span>Historisk informasjon om bygningene og deres rolle i FutureBuilt</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1 text-lokka-primary">•</span>
                  <span>Energidata og bærekraftmetrikker</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1 text-lokka-primary">•</span>
