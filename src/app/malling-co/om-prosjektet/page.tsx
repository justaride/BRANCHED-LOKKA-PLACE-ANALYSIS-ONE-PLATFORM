...
export const metadata = {
  title: 'Om Prosjektet - Malling&Co',
  description: 'Informasjon om Place Analysis for Malling&Co eiendommer på Grünerløkka',
};

export default function MallingCoOmProsjektetPage() {
  return (
    <Container>
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-4 text-gray-600">
              Dette er en dedikert plattform for placeanalyser av Malling&Co eiendommer på Grünerløkka, Oslo.
