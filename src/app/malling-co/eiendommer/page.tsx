...
import { loadAllEiendommer } from '@/lib/loaders/malling-co';

export const metadata = {
  title: 'Malling & Co Eiendommer',
  description: 'Oversikt over Malling & Cos eiendommer på Grünerløkka',
};

export default async function MallingCoEiendommerPage() {
      ...
      <section className="border-b border-gray-200 bg-gradient-to-br from-lokka-primary to-lokka-secondary py-12 text-white">
        <Container>
          ...
          <p className="text-lg text-white/90">
            Utforsk placeanalyser og eiendomsinformasjon for Malling & Cos
