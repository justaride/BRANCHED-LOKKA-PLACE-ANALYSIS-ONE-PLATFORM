        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <div className="flex gap-4">
              ...
              <Link href="/malling-co/om-prosjektet">
                <Button
                  size="lg"
                  variant="outline"
      ...
      <section className="relative w-full overflow-hidden bg-gray-100">
        <div className="relative h-[400px] w-full md:h-[500px] lg:h-[600px]">
          <Image
            ...
            alt="Grünerløkka område - Malling & Co portefølje"
            fill
        ...
        <div className="rounded-xl border-2 border-blue-200 bg-blue-50 p-6 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <Link
                href="/malling-co/om-prosjektet#kontakt"
      ...
      <section className="bg-gradient-to-br from-indigo-600 to-purple-600 py-16">
        <Container>
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-8 text-xl text-white/90">
              Se detaljerte placeanalyser, markedsdata og nøkkelinformasjon for eiendommen i Malling & Co sin portefølje på Grünerløkka.
            </p>
            <Link href="/malling-co/eiendommer">
              <Button
                size="lg"
